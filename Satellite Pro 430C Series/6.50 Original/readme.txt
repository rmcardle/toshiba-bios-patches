README.TXT                                                     04-07-1999 CDC
Flash BIOS version 6.50 for Satellite Pro 430C Series
=============================================================================
...
For purposes of this document, the term "Satellite Pro 430C Series"
...
1010D650.EXE    Self-extracting diskette image of BIOS install diskette
BIOFCD7T.COM    Flash BIOS 6.50 image for Satellite Pro 430C Series
                (provided here for installation methods 2 and 3)
CHGBIOS.EXE     Flash BIOS update utility for Satellite Pro 430C Series
                (provided here for installation methods 2 and 3)
...
self-extracting diskette image manually.  This file is named 1010D650.EXE, and
needs a parameter of A: (1010D650 A:) to successfully create the diskette in
drive A:

The self-extracting diskette image, 1010D650.EXE, will run under MS-DOS or a
...
BIOFCD7T.COM, must be placed on a LOW DENSITY (720 KB) diskette.  A high
...
Insert the diskette that contains CHGBIOS.EXE and BIOFCD7T.COM,
...
to specify where the BIOS image file, BIOFCD7T.COM is located.  Enter
the complete path and file name. Example: C:\2430CV65\BIOFCD7T.COM.

NOTE!
-----

If your path for BIOFCD7T.COM is anywhere other than the root directory
of the A: drive (A:\BIOFCD7T.COM), CHGBIOS will copy the BIOS image
...
which includes the path to the BIOFCD7T.COM file.

   Example: CHGBIOS C:\2430CV65\BIOFCD7T.COM


CHANGE HISTORY
--------------

Version 6.50  04-07-1999
  o  Corrected a problem where, when using an incorrect key floppy
     diskette, the password would be canceled.


Version 6.40  07-09-1997
  o  Resolves compatibility issue with the IBM External 24F keyboard for
     the German market.


Version 6.30  01-09-1997
  o  Update DPMS power management behavior


Version 6.20  11-15-1996
